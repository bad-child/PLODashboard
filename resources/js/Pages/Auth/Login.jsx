            ...
            <style>{`
                ...
                * { box-sizing: border-box; margin: 0; padding: 0; }
                ...
                .login-wrapper {
                    ...
                    /* Create a wavy background pattern using radial gradients */
                    background-image: 
                        radial-gradient(ellipse 150% 100% at 100% -10%, #e8363a 0%, transparent 60%),
                        radial-gradient(ellipse 120% 100% at 0% 120%, #b3161c 0%, transparent 60%);
